...
const startBlockByNetwork: Record<Network, Record<ContractName, number>> = {
  ...
  [Network.RINKEBY]: {
    KTYToken: 4804420, // https://rinkeby.etherscan.io/tx/0x717c61e7a758cb6fbe4bf76dea6713ae2ba85dac291c20b2cb64239a99f32d77
    LegacyNFT: 7644361, // https://rinkeby.etherscan.io/tx/0x8901d8e21d5c18ade19947263903a2d64c662a399ba78d53360b62a9fcb87492
...
class Ethereum {
  ...
  async fetchContracts() {
    const contractsByNetwork: ContractsResponse = {
      "mainnet": {
        KTYToken: '0x8D05F69bd9E804EB467c7e1f2902Ecd5E41a72dA',
        LegacyNFT: '0xec167ad28c74af5c0767ff8f537c49709427cf66',
